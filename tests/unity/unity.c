...
/*-----------------------------------------------*/
void
UnityPrintIntNumberByStyle(const UNITY_INT number, const UNITY_DISPLAY_STYLE_T style)
{
...
void
UnityPrintUintNumberByStyle(const UNITY_UINT number, const UNITY_DISPLAY_STYLE_T style)
{
...
#ifdef UNITY_DETAIL_STACK_SIZE
    {
        ...
        for (c = 0; (c < Unity.CurrentDetailStackSize) && (c < UNITY_DETAIL_STACK_SIZE); c++)
        {
            ...
            if ((label[0] == '#') && (label[1] != 0))
            {
                ...
                {
                    UnityPrintIntNumberByStyle((UNITY_INT)Unity.CurrentDetailStackValues[c],
                                               label[1]);
                }
                else
                {
                    UnityPrintUintNumberByStyle((UNITY_UINT)Unity.CurrentDetailStackValues[c],
                                                label[1]);
                }
            }
...
/*-----------------------------------------------*/
static void
UnityPrintFirstStringDifference(const char *expected, const char *actual, UNITY_UINT32 i_diff)
{
...
/*-----------------------------------------------*/
static void
UnityPrintExpectedAndActualStrings(const char *expected, const char *actual, UNITY_UINT32 i_diff)
{
    UnityPrint(UnityStrExpected);
    if (expected != NULL)
    {
...
/*-----------------------------------------------*/
void
UnityAssertEqualIntNumber(const UNITY_INT             expected,
                          const UNITY_INT             actual,
                          const char                 *msg,
                          const UNITY_LINE_TYPE       lineNumber,
...
void
UnityAssertEqualUintNumber(const UNITY_UINT            expected,
...
/*-----------------------------------------------*/
void
UnityAssertIntGreaterOrLessOrEqualNumber(const UNITY_INT             threshold,
                                         const UNITY_INT             actual,
...
void
UnityAssertUintGreaterOrLessOrEqualNumber(const UNITY_UINT            threshold,
                                          const UNITY_UINT            actual,
                                          const UNITY_COMPARISON_T    compare,
                                          const char                 *msg,
                                          const UNITY_LINE_TYPE       lineNumber,
...
/*-----------------------------------------------*/
void
UnityAssertWithinFloatArray(const UNITY_FLOAT                      delta,
                            ...
                            const UNITY_FLAGS_T                    flags)
{
    ...
    if (UnityIsOneArrayNull(
            (UNITY_INTERNAL_PTR)expected, (UNITY_INTERNAL_PTR)actual, lineNumber, msg))
    {
        UNITY_FAIL_AND_BAIL;
    }
...
/*-----------------------------------------------*/
void
UnityAssertFloatsNotWithin(const UNITY_FLOAT     delta,
                           const UNITY_FLOAT     expected,
                           const UNITY_FLOAT     actual,
                           const char           *msg,
                           const UNITY_LINE_TYPE lineNumber)
...
/*-----------------------------------------------*/
void
UnityAssertGreaterOrLessFloat(const UNITY_FLOAT        threshold,
                              const UNITY_FLOAT        actual,
                              const UNITY_COMPARISON_T compare,
                              const char              *msg,
                              const UNITY_LINE_TYPE    lineNumber)
...
static int
UnityDoublesWithin(UNITY_DOUBLE delta, UNITY_DOUBLE expected, UNITY_DOUBLE actual)
{
    UNITY_DOUBLE diff;
    UNITY_FLOAT_OR_DOUBLE_WITHIN(delta, expected, actual, diff);
}
...
/*-----------------------------------------------*/
void
UnityAssertWithinDoubleArray(const UNITY_DOUBLE                      delta,
...
/*-----------------------------------------------*/
void
UnityAssertDoublesNotWithin(const UNITY_DOUBLE    delta,
                            const UNITY_DOUBLE    expected,
                            const UNITY_DOUBLE    actual,
                            const char           *msg,
                            const UNITY_LINE_TYPE lineNumber)
...
/*-----------------------------------------------*/
void
UnityAssertGreaterOrLessDouble(const UNITY_DOUBLE       threshold,
                               const UNITY_DOUBLE       actual,
                               const UNITY_COMPARISON_T compare,
                               const char              *msg,
                               const UNITY_LINE_TYPE    lineNumber)
...
/*-----------------------------------------------*/
void
UnityAssertIntNumbersWithin(const UNITY_UINT            delta,
                            const UNITY_INT             expected,
                            const UNITY_INT             actual,
                            const char                 *msg,
                            const UNITY_LINE_TYPE       lineNumber,
...
void
UnityAssertUintNumbersWithin(const UNITY_UINT            delta,
...
/*-----------------------------------------------*/
void
UnityAssertNotEqualString(const char           *expected,
                          const char           *actual,
                          const char           *msg,
                          const UNITY_LINE_TYPE lineNumber)
{
...
static enum UnityLengthModifier
UnityLengthModifierGet(const char *pch, int *length)
{
               ...
               const UNITY_LINE_TYPE   line)
{
    ...
    if ((Unity.CurrentDetailStackLabels[Unity.CurrentDetailStackSize - 1] != label)
        || (Unity.CurrentDetailStackValues[Unity.CurrentDetailStackSize - 1] != value))
    {
        UnityTestResultsFailBegin(line);
