...
#define IRTDEF(_)                                                                             \
    _(NIL, 4)                                                                                 \
    _(FALSE, 4)                                                                               \
    _(TRUE, 4) _(LIGHTUD, LJ_64 ? 8 : 4) _(STR, IRTSIZE_PGC) _(P32, 4) _(THREAD, IRTSIZE_PGC) \
        _(PROTO, IRTSIZE_PGC) _(FUNC, IRTSIZE_PGC) _(P64, 8) _(CDATA, IRTSIZE_PGC)            \
            _(TAB, IRTSIZE_PGC) _(UDATA, IRTSIZE_PGC) _(FLOAT, 4) _(NUM, 8) _(I8, 1) _(U8, 1) \
                _(I16, 2) _(U16, 2) _(INT, 4) _(U32, 4) _(I64, 8) _(U64, 8)                   \
...
#define IRT_IS64                                                                                 \
    ((1u << IRT_NUM) | (1u << IRT_I64) | (1u << IRT_U64) | (1u << IRT_P64) | (1u << IRT_LIGHTUD) \
     | (1u << IRT_STR) | (1u << IRT_THREAD) | (1u << IRT_PROTO) | (1u << IRT_FUNC)               \
     | (1u << IRT_CDATA) | (1u << IRT_TAB) | (1u << IRT_UDATA) | (1u << IRT_NIL))
#elif LJ_64
#define IRT_IS64 \
    ((1u << IRT_NUM) | (1u << IRT_I64) | (1u << IRT_U64) | (1u << IRT_P64) | (1u << IRT_LIGHTUD))
#else
...
static LJ_AINLINE IRType
itype2irt(const TValue *tv)
{
    if (tvisint(tv))
    {
        return IRT_INT;
...
irt_toitype_(IRType t)
{
    lj_assertX(!LJ_64 || LJ_GC64 || t != IRT_LIGHTUD, "no plain type tag for lightuserdata");
...
#define ir_kptr(ir) \
    check_exp((ir)->o == IR_KPTR || (ir)->o == IR_KKPTR, mref((ir)[LJ_GC64].ptr, void))
