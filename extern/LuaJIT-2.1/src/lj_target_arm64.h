...
#define GPRDEF(_)                                                                                  \
    _(X0)                                                                                          \
    _(X1)                                                                                          \
    _(X2) _(X3) _(X4) _(X5) _(X6) _(X7) _(X8) _(X9) _(X10) _(X11) _(X12) _(X13) _(X14) _(X15)      \
        _(X16) _(X17) _(X18) _(X19) _(X20) _(X21) _(X22) _(X23) _(X24) _(X25) _(X26) _(X27) _(X28) \
            _(FP) _(LR) _(SP)
#define FPRDEF(_)                                                                                  \
    _(D0)                                                                                          \
    _(D1)                                                                                          \
    _(D2) _(D3) _(D4) _(D5) _(D6) _(D7) _(D8) _(D9) _(D10) _(D11) _(D12) _(D13) _(D14) _(D15)      \
        _(D16) _(D17) _(D18) _(D19) _(D20) _(D21) _(D22) _(D23) _(D24) _(D25) _(D26) _(D27) _(D28) \
            _(D29) _(D30) _(D31)
#define VRIDDEF(_)
...
#define RSET_FIXED \
    (RID2RSET(RID_X18) | RID2RSET(RID_FP) | RID2RSET(RID_LR) | RID2RSET(RID_SP) | RID2RSET(RID_GL))
...
exitstub_trace_addr_(uint32_t *p, uint32_t exitno)
{
    while (*p == (LJ_LE ? 0xd503201f : 0x1f2003d5))
    {
        p++; /* Skip A64I_NOP. */
    }
    if ((LJ_LE ? p[1] >> 28 : p[1] & 0xf) == 0xf)
    {
        p++; /* Skip A64I_LDRx. */
    }
    return p + 3 + exitno;
