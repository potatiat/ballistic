...
#define GPRDEF(_)                                                                           \
    _(EAX)                                                                                  \
    _(ECX)                                                                                  \
    _(EDX) _(EBX) _(ESP) _(EBP) _(ESI) _(EDI) _(R8D) _(R9D) _(R10D) _(R11D) _(R12D) _(R13D) \
        _(R14D) _(R15D)
#define FPRDEF(_)                                                                              \
    _(XMM0)                                                                                    \
    _(XMM1)                                                                                    \
    _(XMM2) _(XMM3) _(XMM4) _(XMM5) _(XMM6) _(XMM7) _(XMM8) _(XMM9) _(XMM10) _(XMM11) _(XMM12) \
        _(XMM13) _(XMM14) _(XMM15)
#else
...
#define RSET_GPR \
    (RSET_RANGE(RID_MIN_GPR, RID_MAX_GPR) - RID2RSET(RID_ESP) - LJ_GC64 * RID2RSET(RID_DISPATCH))
...
#define REGARG_GPRS \
    (RID_EDI        \
     | ((RID_ESI | ((RID_EDX | ((RID_ECX | ((RID_R8D | (RID_R9D << 5)) << 5)) << 5)) << 5)) << 5))
