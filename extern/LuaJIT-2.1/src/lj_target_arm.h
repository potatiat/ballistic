...
#define GPRDEF(_) \
    _(R0)         \
    _(R1) _(R2) _(R3) _(R4) _(R5) _(R6) _(R7) _(R8) _(R9) _(R10) _(R11) _(R12) _(SP) _(LR) _(PC)
#if LJ_SOFTFP
#define FPRDEF(_)
#else
#define FPRDEF(_) \
    _(D0)         \
    _(D1) _(D2) _(D3) _(D4) _(D5) _(D6) _(D7) _(D8) _(D9) _(D10) _(D11) _(D12) _(D13) _(D14) _(D15)
#endif
#define VRIDDEF(_)
...
#define RSET_GPREVEN                                                                              \
    (RID2RSET(RID_R0) | RID2RSET(RID_R2) | RID2RSET(RID_R4) | RID2RSET(RID_R6) | RID2RSET(RID_R8) \
     | RID2RSET(RID_R10))
#define RSET_GPRODD                                                                               \
    (RID2RSET(RID_R1) | RID2RSET(RID_R3) | RID2RSET(RID_R5) | RID2RSET(RID_R7) | RID2RSET(RID_R9) \
     | RID2RSET(RID_R11))
#if LJ_SOFTFP
#define RSET_FPR 0
#else
