...
LJ_FUNC_NORET void lj_assert_fail(
    global_State *g, const char *file, int line, const char *func, const char *fmt, ...);
#endif
...
#if LJ_64
#define lightudseg(u) (((u) >> LJ_LIGHTUD_BITS_LO) & ((1 << LJ_LIGHTUD_BITS_SEG) - 1))
#define lightudlo(u)  ((u) & (((uint64_t)1 << LJ_LIGHTUD_BITS_LO) - 1))
#define lightudup(p)  ((uint32_t)(((p) >> LJ_LIGHTUD_BITS_LO) << (LJ_LIGHTUD_BITS_LO - 32)))
static LJ_AINLINE void *
lightudV(global_State *g, cTValue *o)
{
    uint64_t  u      = o->u64;
    uint64_t  seg    = lightudseg(u);
    uint32_t *segmap = mref(g->gc.lightudseg, uint32_t);
    lj_assertG(tvislightud(o), "lightuserdata expected");
    if (seg == (1 << LJ_LIGHTUD_BITS_SEG) - 1)
    {
        return NULL;
    }
...
static LJ_AINLINE void
setrawlightudV(TValue *o, void *p)
{
#if LJ_GC64
...
static LJ_AINLINE void
checklivetv(lua_State *L, TValue *o, const char *msg)
{
    UNUSED(L);
    UNUSED(o);
    UNUSED(msg);
...
static LJ_AINLINE void
setgcVraw(TValue *o, GCobj *v, uint32_t itype)
{
#if LJ_GC64
...
static LJ_AINLINE void
setgcV(lua_State *L, TValue *o, GCobj *v, uint32_t it)
{
    setgcVraw(o, v, it);
...
/* Copy tagged values. */
static LJ_AINLINE void
copyTV(lua_State *L, TValue *o1, const TValue *o2)
{
    *o1 = *o2;
...
#define lj_num2int_check(x, i64, i) lj_num2int_cond((x), i64, i, i64 >= 0)
