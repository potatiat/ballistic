...
static LJ_AINLINE SBufExt *
buffer_tobufw(lua_State *L)
{
...
LJLIB_CF(buffer_method_put) LJLIB_REC(.)
{
    ...
    retry:
        ...
        else if (tvisbuf(o))
        {
            ...
            if (sbx2 == sbx)
            {
                lj_err_arg(L, (int)(arg + 1), LJ_ERR_BUFFER_SELF);
            }
...
int
luaopen_string_buffer(lua_State *L)
{
