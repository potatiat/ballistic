...
#define JIT_F_OPTSTRING "\4fold\3cse\3dce\3fwd\3dse\6narrow\4loop\3abc\4sink\4fuse\3fma"
...
#define JIT_F_OPT_3 \
    (JIT_F_OPT_2 | JIT_F_OPT_FWD | JIT_F_OPT_DSE | JIT_F_OPT_ABC | JIT_F_OPT_SINK | JIT_F_OPT_FUSE)
...
#define SNAP_TR(slot, tr) \
    (((SnapEntry)(slot) << 24) + ((tr) & (TREF_KEYINDEX | TREF_CONT | TREF_FRAME | TREF_REFMASK)))
#if !LJ_FR2
...
static LJ_AINLINE const BCIns *
snap_pc(SnapEntry *sn)
{
#if LJ_FR2
    uint64_t pcbase;
...
snap_nextofs(GCtrace *T, SnapShot *snap)
{
