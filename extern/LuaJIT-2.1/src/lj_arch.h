...
#else
#error \
    "Architecture not supported (in this version), see: https://luajit.org/status.html#architectures"
#endif
...
#if !defined(LJ_ABI_BRANCH_TRACK) && (__CET__ & 1) && LJ_TARGET_GC64 \
...
#elif __ARM_ARCH == 7 || __ARM_ARCH_7__ || __ARM_ARCH_7A__ || __ARM_ARCH_7R__ || __ARM_ARCH_7S__ \
    || __ARM_ARCH_7VE__
#define LJ_ARCH_VERSION 70
#elif __ARM_ARCH_6T2__
#define LJ_ARCH_VERSION 61
#elif __ARM_ARCH == 6 || __ARM_ARCH_6__ || __ARM_ARCH_6J__ || __ARM_ARCH_6K__ || __ARM_ARCH_6Z__ \
    || __ARM_ARCH_6ZK__
...
#error "Need at least GCC 4.2 or newer"
    ...
    && !defined(__NX_TOOLCHAIN_MAJOR__)
...
#if defined(LUAJIT_NO_UNWIND) || __GNU_COMPACT_EH__ || defined(__symbian__) || LJ_TARGET_IOS \
...
#define LJ_SECURITY_MODE                                                           \
    (0u | ((LUAJIT_SECURITY_PRNG & 3) << 0) | ((LUAJIT_SECURITY_STRHASH & 3) << 2) \
     | ((LUAJIT_SECURITY_STRID & 3) << 4) | ((LUAJIT_SECURITY_MCODE & 3) << 6))
#define LJ_SECURITY_MODESTRING "\004prng\007strhash\005strid\005mcode"
