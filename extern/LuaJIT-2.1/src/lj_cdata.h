...
/* Set C data pointer. */
static LJ_AINLINE void
cdata_setptr(void *p, CTSize sz, const void *v)
{
    if (LJ_64 && sz == 4)
    { /* Support 32 bit pointers on 64 bit targets. */
...
static LJ_AINLINE GCcdata *
lj_cdata_new(CTState *cts, CTypeID id, CTSize sz)
{
    GCcdata *cd;
...
static LJ_AINLINE GCcdata *
lj_cdata_new_(lua_State *L, CTypeID id, CTSize sz)
{
