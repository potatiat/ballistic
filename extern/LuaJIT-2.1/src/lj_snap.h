...
LJ_FUNC IRIns       *lj_snap_regspmap(jit_State *J, GCtrace *T, SnapNo snapno, IRIns *ir);
...
lj_snap_grow_buf(jit_State *J, MSize need)
{
...
static LJ_AINLINE void
lj_snap_grow_map(jit_State *J, MSize need)
{
