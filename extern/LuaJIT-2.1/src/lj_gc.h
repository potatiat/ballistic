...
lj_gc_barrierback(global_State *g, GCtab *t)
{
    GCobj *o = obj2gco(t);
    lj_assertG(isblack(o) && !isdead(g, o), "bad object states for backward barrier");
...
static LJ_AINLINE void
lj_mem_free(global_State *g, void *p, size_t osize)
{
